...
class Info(commands.Cog):
    ...
    async def info(self, ctx: commands.Context):
        ...
        embed = discord.Embed(title=f'{self.client.user.name}', color=discord.Colour.from_str(tether.color))
        ...
        embed.add_field(name="Total Servers", value=f'```{len(self.client.guilds)}```', inline=False)
