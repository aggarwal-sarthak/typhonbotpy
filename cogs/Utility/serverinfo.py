...
class serverinfo(commands.Cog):
    ...
    @commands.command(description='Returns Information About Server', aliases=['server'], usage=f"{os.path.basename(__file__)[:-3]}")
    ...
    async def serverinfo(self, ctx):
        ...
        embed.add_field(name="**__Features__**", value=f"{features[:-2]}")
